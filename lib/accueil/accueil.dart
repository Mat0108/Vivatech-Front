          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ButtonAccueil('assets/images/accueil/image-5.png', 'Mon pass',
                      const Color(0xff00ffff), fem, ffem),
                  ButtonAccueil('assets/images/accueil/image-19.png', 'Jeux',
                      const Color(0xff00ff00), fem, ffem),
                  ButtonAccueil('assets/images/accueil/image-20.png', 'Plan',
                      const Color(0xffffff00), fem, ffem),
                  ButtonAccueil('assets/images/accueil/image-8.png', 'CV',
                      const Color(0xfff15700), fem, ffem),
                ],
              ),
            ),
            CarouselWithIndicatorDemo(type: "1"),
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                titre,
                style:
                    const TextStyle(fontSize: 14, color: VivatechColor.white),
              ),
            ),
          ],
        ));
