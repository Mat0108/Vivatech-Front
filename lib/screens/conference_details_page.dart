...
// Création des sessions pour chaque jour
    ...
    Session session24 = Session("10:45 - 11:15", [presenter52, presenter53],
        "Performance sportive : utiliser les données pour gagner");
    Session session25 = Session(
        "10:00 - 10:45",
        [presenter54, presenter55, presenter56],
        "L'énergie de l'Europe: de la crise au catalyseur");
    Session session26 = Session("10:30 - 11:00", [presenter57, presenter58],
        "La dernière technologie de voile rendra-t-elle les skippers obsolètes ?");
    Session session27 = Session("10:40 - 11:05", [presenter59, presenter60],
        "Le Web3 deviendra-t-il grand public?");
    Session session28 = Session("11:00 - 11:30", [presenter61, presenter62],
        "La voile peut-elle vraiment soutenir la durabilité ?");
    Session session29 = Session("11:30 - 12:05", [presenter63, presenter64],
        "Zéro gaspi : du déchet à l'opportunité");
    Session session30 = Session(
        "12:15 - 13:00",
        [presenter65, presenter66, presenter67],
        "Tech to Watch : Les métiers d'avenir (et comment s'y préparer)");
